    ...
    <div class="py-12">
        ...
        <div class="flex justify-center">
            ...
            <div class="p-5 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <h1 class="mb-3 font-bold">Edit Product</h2>

                    <form class="space-y-6" action="{{ route('products.update', ['product' => $product->id]) }}"
                        ...
                        <div>
                            ...
                            <select
                                ...
                                @foreach ($tags as $tag)
                                    <option {{ in_array($tag->id, $selectedTags) ? 'selected' : '' }}
                        ...
                        <div>
                            ...
                            <textarea
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white-300 dark:border-gray-500 dark:placeholder-gray-400 dark:text-black"
                                name="description" id="description" cols="36" rows="5">{{ $product->description }}</textarea>
                        </div>
                        <button type="submit"
